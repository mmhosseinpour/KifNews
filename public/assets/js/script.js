...
(function ($) {
  ...
  $('#cartEffect').on('click', function (e) {
    if ($("#selectSize .size-box ul").hasClass('selected')) {
      $('#cartEffect').text("به سبد خرید افزوده شد ");
  ...
  $('.sidebar-popup').on('click', function (e) {
    ...
    $('.collection-filter').css("right", "-15px");
  });
  $('.filter-main-btn').on('click', function (e) {
    $('.collection-filter').css("right", "-15px");
  });
  $('.filter-back').on('click', function (e) {
    $('.collection-filter').css("right", "-365px");
    $('.sidebar-popup').trigger('click');
  });

  $('.account-sidebar').on('click', function (e) {
    $('.dashboard-left').css("right", "0");
  });
  $('.filter-back').on('click', function (e) {
    $('.dashboard-left').css("right", "-365px");
  });
  ...
  $(function () {
    ...
    $(".loadMore").on('click', function (e) {
      ...
      if ($(".col-grid-box:hidden").length == 0) {
        $(".load-more-sec").text('محصولات بیشتری وجود ندارد');
      }
    });
  });
  ...
  body_event.on("click", ".theme-layout-version", function () {
    ...
    if ($('.theme-layout-version').hasClass('dark')) {
      $('.theme-layout-version').text('روشن');
      $('body').addClass('dark');
    } else {
      $('#theme-dark').remove();
      $('.theme-layout-version').text('تاریک');
    }
  ...
  $('.add-to-wish').on('click', function () {
    ...
    $.notify({
      icon: 'fa fa-check',
      title: 'موفق!',
      message: 'محصول با موفقیت به لیست علاقه مندی شما اضافه شد'
    }, {
      element: 'body',
      position: null,
      type: "info",
