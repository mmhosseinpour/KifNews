                ...
                <div class="col-xl-5 col-md-8 col-sm-6">
                    <div class="top-header-left">
                        <div class="shpping-order">
                            <h6>ارسال رایگان برای سفارشات بالای 99 هزار تومان </h6>
                        </div>
                        <div class="app-link">
                            <h6>
                                دانلود اپلیکیشن
                ...
                <div class="col-xl-7 col-md-4 col-sm-6">
                    <div class="top-header-right">
                        <div class="top-menu-block">
                            <ul>
                                <li><a href="javascript:void(0)">کارت های هدیه</a></li>
                                <li><a href="javascript:void(0)">اعلان ها</a></li>
                                <li><a href="javascript:void(0)">راهنمایی و تماس</a></li>
                                <li><a href="javascript:void(0)">پیشنهاد های روزانه</a></li>
                                <li><a href="javascript:void(0)">سفارشات</a></li>
                                <li><a href="javascript:void(0)">حمل و نقل </a></li>
                                <li><a href="javascript:void(0)">مرجوع آسان</a></li>
                            </ul>
                        </div>
                  ...
                  <span class="language-dropdown-click">
                    فارسی <i class="fa fa-angle-down" aria-hidden="true"></i>
                                ...
                                <ul class="language-dropdown-open">
                                    ...
                                    <li><a href="javascript:void(0)">فارسی</a></li>
                                    <li><a href="javascript:void(0)">ترکی استانبولی</a></li>
                                    <li><a href="javascript:void(0)">عربی</a></li>
                                </ul>
                            </div>
                            <div class="curroncy-dropdown">
                  <span class="curroncy-dropdown-click">
                    تومان<i class="fa fa-angle-down" aria-hidden="true"></i>
                  </span>
                                <ul class="curroncy-dropdown-open">
                                    <li><a href="javascript:void(0)"><i class="fa fa-inr"></i>تومان</a></li>
                                    <li><a href="javascript:void(0)"><i class="fa fa-usd"></i>دلار</a></li>
                                    <li><a href="javascript:void(0)"><i class="fa fa-eur"></i>لیر</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <span class="sm-nav-btn">
                  <i class="fa fa-bars"></i>
                    ...
                    <div class="input-block">
                        <div class="input-box">
                            <form class="big-deal-form " action="/" method="post">
                                <div class="input-group ">
                                    <div class="input-group-text">
                                        <button type="submit" class="search"><i class="fa fa-search"></i></button>
                                    </div>
                                    <input type="search" class="form-control" name="key" placeholder="جستجوی یک محصول">
                                    <div class="input-group-text">
                                        <select>
        ...
        <div class="searchbar-input">
            ...
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
              ...
              <g>
                ...
                <input type="text" name="key" class="form-control" placeholder="جستجو محصول شما">
                <button type="submit" class="input-group-text close-searchbar">
                                                    ...
                                                    <div class="row">
                                                        <div class="col mega-box">
                                                            <div class="link-section">
                                                                ...
                                                                <div class="menu-content">
                                                                    <ul>
                                                                        <li><a href="product-page(left-sidebar).html">سایدبار
                                                                                راست</a></li>
                                                                        <li><a href="product-page(right-sidebar).html">سایدبار
                                                                                چپ</a></li>
                                                                        <li><a href="product-page(no-sidebar).html">بدون
                                                                                سایدبار</a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col mega-box">
                                                            <div class="link-section">
                                                                ...
                                                                <div class="menu-content">
                                                                    <ul>
                                                                        <li><a href="product-page(bundle).html">پکیج
                                                                                محصولات</a></li>
                                                                        <li><a href="product-page(image-swatch).html">مشاهده
                                                                                تصاویر</a></li>
                                                                        <li><a href="product-page(vertical-tab).html">تب
                                                                                عمودی</a></li>
                                                                        <li>
                                                                            <a href="product-page(video-thumbnail).html">ویدئو
                                                                                بندانگشتی</a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="menu-content">
                                                                    <ul>
                                                                        <li><a href="product-page(4-image).html">4
                                                                                تصویر </a></li>
                                                                        <li>
                                                                            <a href="product-page(sticky).html">چسبنده</a>
                                                                        </li>
                                                                        <li><a href="product-page(accordian).html">آکاردئون</a>
                                                                        </li>
                                                                        <li><a href="product-page(360-view).html">نمایش
                                                                                360 درجه</a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col mega-box">
                                                            <div class="link-section">
                                                                ...
                                                                <div class="menu-content">
                                                                    <ul>
                                                                        <li><a href="product-page(left-image).html">تصاویر
                                                                                راست</a></li>
                                                                        <li><a href="product-page(right-image).html">تصاویر
                                                                                چپ</a></li>
                                                                        <li><a href="product-page(image-outside).html">تصاویر
                                                                                بیرونی</a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col mega-box">
                                                            <div class="link-section">
                                                                ...
                                                                <div class="menu-content">
                                                                    <ul>
                                                                        <li><a href="product-page(3-col-left).html">تصاویر
                                                                                بندانگشتی راست</a></li>
                                                                        <li><a href="product-page(3-col-right).html">تصاویر
                                                                                بندانگشتی چپ</a></li>
                                                                        <li><a href="product-page(3-column).html">تصاویر
                                                                                بندانگشتی پایین</a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col mega-box">
                                                            <div class="link-section">
                                                                ...
                                                                <div class="menu-content">
                                                                    <ul>
                                                                        <li><a href="element-productbox.html">باکس
                                                                                محصول</a></li>
                                                                        <li><a href="element-product-slider.html">اسلایدر
                                                                                محصولات</a></li>
                                                                        <li><a href="element-no_slider.html">بدون
                                                                                اسلایدر</a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col mega-box">
                                                            <div class="link-section">
                                                                ...
                                                                <div class="menu-content">
                                                                    <ul>
                                                                        <li><a href="grid-2-col.html">شبکه بندی 2
                                                                                ستونه</a></li>
                                                                        <li><a href="grid-3-col.html">شبکه بندی 3
                                                                                ستونه</a></li>
                                                                        <li><a href="grid-4-col.html">شبکه بندی 4
                                                                                ستونه</a></li>
                                                                        <li><a href="grid-6-col.html">شبکه بندی 6
                                                                                ستونه</a></li>
                                                                        <li><a href="masonary-2-grid.html">طرح Masonry 2
                                                                                ستونه</a></li>
                                                                        <li><a href="masonary-3-grid.html">طرح Masonry 3
                                                                                ستونه</a></li>
                                                                        <li><a href="masonary-4-grid.html">طرح Masonry 4
                                                                                ستونه</a></li>
                                                                        <li><a href="masonary-fullwidth.html">طرح
                                                                                Masonry تمام عرض</a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col mega-box">
                                                            <div class="link-section">
                                                                ...
                                                                <div class="menu-content">
                                                                    <ul>
                                                                        <li><a href="layout-5.html">سبد خرید پاپ آپ</a>
                                                                        </li>
                                                                        <li><a href="layout-6.html">شمارنده تعداد </a>
                                                                        </li>
                                                                        <li><a href="index.html">سبد خرید بالا</a></li>
                                                                        <li><a href="layout-2.html">سبد خرید پایین</a>
                                                                        </li>
                                                                        <li><a href="layout-3.html">سبد خرید راست</a>
                                                                        </li>
                                                            ...
                                                            <div class="link-section">
                                                                ...
                                                                <div class="menu-content">
                                                                    <ul>
                                                                        ...
                                                                        <li><a href="element-category.html">دسته
                                                                                بندی</a></li>
                                                                        <li><a href="element-service.html">خدمات</a>
                                                                        </li>
                                                                        <li><a href="element-image-ratio.html">نسبت
                                                                                تصویر</a></li>
                                                                        <li><a href="element-tab.html">تب بندی</a></li>
                                                                        <li><a href="element-counter.html">شمارنده</a>
                                                                        </li>
                                                                        <li><a href="element-pricingtable.html">جدول
                                                                                قیمت گذاری</a></li>
                                                                        <li><a href="element-team.html">تیم</a></li>
                                                                        <li><a href="element-testimonial.html">نظرات</a>
                                                                        </li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li><a href="checkout2.html">پرداخت 2<span class="new-tag">جدید</span></a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                </ul>
                        ...
                        <div class="category-right">
                            <div class="contact-block">
                                <div>
                                    ...
                                    <span>تماس با ما<span>02155667788</span></span>
                                </div>
                            </div>
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu gift-dropdown">
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p>برای خرید گوشی های هوشمند محبوب</p>
                                        </div>
                                    </div>
                                    <div class="media">
                                        <div class="me-3">
                        ...
                        <div class="product-box">
                            <div class="product-imgbox">
                                <div class="product-front">
                                    <img src="{{$item->ga}}" class="img-fluid  " alt="product">
                                </div>
            ...
            <div class="col-12">
                <div class="subscribe-contain">
                    ...
                    <div class="subscribe-right">
                        <div class="input-group">
                            <input class="form-control" type="text" placeholder="ایمیل خود را وارد کنید">
                            <div class="input-group-text">عضویت</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="footer-main">
                        ...
                        <div class="footer-box">
                            ...
                            <div class="footer-contant">
                                <ul>
                                    <li><a href="javascript:void(0)">موقعیت مکانی فروشگاه</a></li>
                                    <li><a href="javascript:void(0)"> حساب کاربری</a></li>
                                    <li><a href="javascript:void(0)"> پیگیری سفارشات</a></li>
                                    <li><a href="javascript:void(0)"> راهنمای سایز</a></li>
                                    <li><a href="javascript:void(0)">سوالات متداول </a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="footer-box">
                            ...
                            <div class="footer-contant">
                                <ul class="contact-list">
                                    <li>
                                        <i class="fa fa-map-marker"></i><span>تهران، میدان آزادی، خیابان آزادی <br> <span>
                        ...
                        <div class="newslatter-main">
                            <div class="offer-content">
                                <div>
                                    ...
                                    <h2>خبرنامه</h2>
                                    <p>در خبرنامه فروشگاه ما عضو شوید و<br> از پیشنهاد های شگفت انگیز ما با خبر شوید !
                                    </p>
                                    <form action="javascript:void(0)" class="auth-form needs-validation" method="post"
...
<div id="cart_side" class="add_to_cart right ">
    ...
    <div class="cart-inner">
        ...
        <div class="cart_media">
                ...
                <li>
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <h6>
                                80,000 تومان <span>120,000 تومان</span>
                            </h6>
                            <div class="addit-box">
                                <div class="qty-box">
                                    <div class="input-group">
            ...
            <ul class="cart_total">
                <li>
                    جمع سبد خرید : <span>105,000 تومان</span>
                </li>
                <li>
                ...
                <li>
                    <div class="total">
                        جمع کل<span>105,000 تومان</span>
                    </div>
                </li>
                <li>
                    <div class="buttons">
                        <a href="cart.html" class="btn btn-solid btn-sm">سبد خرید</a>
                        <a href="checkout.html" class="btn btn-solid btn-sm ">پرداخت</a>
                    </div>
                </li>
            </ul>
        </div>
    ...
    <div class="cart-inner">
        ...
        <div class="cart_media">
            ...
            <ul class="cart_total">
                ...
                <li>
                    <div class="buttons">
                        <a href="wishlist.html" class="btn btn-solid btn-block btn-md">مشاهده لیست علاقه مندی</a>
                    </div>
                </li>
            </ul>
        </div>
    ...
    <div class="cart-inner">
        ...
        <form class="theme-form">
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" id="review" placeholder="رمز عبور خود را وارد کنید"
                       required="">
            </div>
            <div class="form-group">
                <a href="javascript:void(0)" class="btn btn-solid btn-md btn-block ">ورود</a>
            </div>
