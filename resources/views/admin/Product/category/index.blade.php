                                ...
                                <tr>
                                    ...
                                    <td><span>
                                        <?php
                                            ...
                                            ?>                                        </span></td>
                                    <td class="row col-12">
                                        <form class="col-lg-6 inline-block" action="/admin/ManageProductCategory/{{$item->id}}"
                                              method="post">
                                            @method('delete')
                                            @csrf
                                        ...
                                        <a class="col-lg-6 inline-block" href="/admin/ManageProductCategory/{{$item->id}}/edit">
